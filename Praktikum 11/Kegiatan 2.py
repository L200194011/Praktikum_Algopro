...
class App(Frame):
    ...
    def initUI(self):
        self.parent.title("Kalkulator Sederhana by DimasR")
        ...
        lbl1 = Label(frame1, text="Angka 1", width=15)
        ...
        lbl2 = Label(frame2, text="Angka 2", width=15)
        ...
        lbl3 = Label(frame4, text="Hasil", width=10)
    ...
    def errorMsg(self,msg):
        if msg == 'error':
            tkinter.messagebox.showerror('Error!', 'Ada yang salah! Mungkin tidak memasukkan angka')
        elif msg == 'divisionerror':
            tkinter.messagebox.showerror('Perhitungan gagal!', 'Anda memasukan angka 0 pada angka kedua. Tidak Bisa dibagi 0')
